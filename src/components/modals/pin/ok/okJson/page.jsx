...
const OkPIN = ({
    ...
    modalEdit,
    formTypeModal,
    isModalOpen, // Adiciona uma prop para controlar o estado do modal
    setIsModalOpen, // Função para controlar a abertura do modal
}) => {
    ...
    return (
        <>
            {formTypeModal === 11 && (
                <>
                    {/* Remover o onOpen aqui e deixar o controle do modal com o pai */}
                    <Button 
                        fullWidth={true} 
                        size="ms" 
                        color="primary" 
                        className="bg-primary text-white font-semibold p-2 rounded-lg w-[10px]"
                        onClick={() => setIsModalOpen(true)} // Controla a abertura do modal aqui
                    >
                        {buttonName} {buttonIcon}
                    </Button>
                    <Modal
                        isOpen={isModalOpen} // Agora o estado é controlado pelo componente pai
