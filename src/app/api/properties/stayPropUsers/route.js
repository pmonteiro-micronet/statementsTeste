...
export async function GET() {
  try {
    const response = await prisma.stayPropUsers.findMany();
...
export async function PUT(req) {
  try {
    ...
    const updatedProperties = await prisma.stayPropUsers.create({
      data: {
        propertyID,
        userID,
      },
...
export async function DELETE(req) {
  try {
    ...
    const deleted = await prisma.stayPropUsers.deleteMany({
      where: {
        propertyID,
        userID,
      },
