...
export async function POST(request) {
    try {
        ...
        const { propertyID, refnr, internalRoom, description, localText, solved, sdate, stime, suser } = body;

        console.log("Received data:", body);
        // Validações básicas
        if (!propertyID || !refnr || !internalRoom || !description || !localText == null) {
        ...
        const url = `http://${property.propertyServer}:${property.propertyPort}/updatemaintenance`;
        ...
        const response = await axios.post(
            ...
            {},
            {
                headers: {
                    ...
                    textlokal: localText,
                    solved: solved ? 1 :0,
                    sdate: sdate || "1900-01-01 00:00:00.000",
                    stime: stime || "00:00",
                    suser: suser || "n",
