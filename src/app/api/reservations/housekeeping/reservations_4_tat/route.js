...
export async function GET(request) {
  ...
  try {
    ...
    const url = `http://${propertyServer}:${propertyPort}/housekeeping`;
    ...
    if (response.data && Array.isArray(response.data)) {
      ...
      await prisma.requestRecordsHousekeeping.deleteMany({
        where: {
      ...
      const newRequest = await prisma.requestRecordsHousekeeping.create({
        data: {
