...
export async function GET(request) {
  ...
  try {
    ...
    const url = `http://${propertyServer}:${propertyPort}/getallreservations`;
    ...
    if (response.data && Array.isArray(response.data)) {
      // Apagar todos os registros da tabela requestRecordsReservationsOta antes de inserir novos dados
      await prisma.requestRecordsReservationsOta.deleteMany({
        where: {
      ...
      const newRequest = await prisma.requestRecordsReservationsOta.create({
        data: {
